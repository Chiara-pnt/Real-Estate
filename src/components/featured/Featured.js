        ...
        <div className='container'>
            ...
            <div className='span-3 img-details'>
                ...
                <div className='info-grid'>
                    <div>
                        <div className='info'>
                            <p className='bold'>Bedroms:</p><p>5</p>
                        </div>
                        <div className='info'>
                            <p className='bold'>Bathroms:</p><p>7</p>
                        </div>
                    </div>
                    <div>
                        <div className='info'>
                            <p className='bold'>Square Feet:</p><p>8.135</p>
                        </div>
                        <div className='info'>
                            <p className='bold'>East Payment:</p><p>$14.797/mo</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <p>A beautiful modern day home in the city with a full-size pool. 
                ...
                Including media room, workout facility, and built-in sauna. 
            </p>
